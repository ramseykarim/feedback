...
def cut_across_m16_pillars_again():
    ...
    colors, path_list, path_name, vlims, grid_shape, region_name = crosscut.setup_paths(2, select=2)
    ...
    # plt.show()
    plt.tight_layout()
    fig.savefig("/home/ramsey/Pictures/2021-01-26-imgs/across_all_xcut.png")
