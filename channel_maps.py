...
# file paths
# Data directory
data_file_directory = "/home/ramsey/Downloads"
# Wherever the figures go
figure_save_path = "/home/ramsey/Pictures/2023-08-10"

data_filepaths = { # Original data
    'rcw120': os.path.join(data_file_directory, "rcw120-cii-20arcsec-0-5kms.fits"),
    'rcw49': os.path.join(data_file_directory, "rcw49-cii-25arcsec-1kms.fits"),
    'ngc1977': os.path.join(data_file_directory, "ngc1977-data.fits"),
}

data_rebinned_filepaths = { # Rebinned data (after running rebin_spectra)
    'rcw120': os.path.join(data_file_directory, "rcw120-cii-20arcsec-0-5kms.rebin2kms.fits"),
    'rcw49': os.path.join(data_file_directory, "rcw49-cii-25arcsec-1kms.rebin2kms.fits"),
    'ngc1977': os.path.join(data_file_directory, "ngc1977-data.rebin1kms.fits"),
}
